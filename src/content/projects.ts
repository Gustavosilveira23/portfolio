...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: {
      pt: "Plataforma de analytics com IA para criadores de conteúdo. Lê sinais de performance e devolve insights que separam problemas de conteúdo de problemas de algoritmo.",
      en: "AI-powered analytics platform for content creators. Reads performance signals and returns insights that separate content problems from algorithm problems.",
    },
    context: {
      pt: "Criadores de conteúdo enfrentam duas dores recorrentes: paralisia criativa (não saber o que postar) e a caixa preta do algoritmo (não entender por que posts flopam). O Raio X Creator nasceu para tirar decisões simples de dados complexos: um plano diário acionável.\n\nO produto analisa conteúdo, performance e audiência para entregar diagnósticos que separam o que é problema de conteúdo do que é problema de algoritmo.",
      en: "Content creators face two recurring pain points: creative paralysis (not knowing what to post) and the algorithm black box (not understanding why posts flop). Raio X Creator was built to pull simple decisions out of complex data: a daily actionable plan.\n\nThe product analyzes content, performance, and audience to deliver diagnostics that separate content problems from algorithm problems.",
    },
    role: {
  ...
  },
  {
    ...
    context: {
      pt: "O Instituto Sonho Grande atua para reduzir o abandono escolar nas escolas públicas brasileiras. O desafio era criar uma ferramenta que tirasse ações concretas de dados complexos sobre risco de evasão: algo que gestores escolares e secretarias de educação pudessem usar no dia a dia, sem treinamento técnico.\n\nA tela tinha que responder duas perguntas em segundos: \"quais alunos estão em risco?\" e \"o que eu faço a respeito?\".",
      en: "Instituto Sonho Grande works to reduce school dropout across Brazilian public schools. The challenge was building a tool that pulled concrete action out of complex dropout risk data: something school managers and education departments could use day-to-day, without technical training.\n\nThe interface had to answer two questions in seconds: \"which students are at risk?\" and \"what do I do about it?\".",
    },
    role: {
